...
const actionSeverityMap: Record<AuditActionType, AuditSeverity> = {
  ...
  GOVERNANCE_ACCESS_DENIED: AuditSeverity.MEDIUM,
  ROOT_SHIELDING_TRIGGERED: AuditSeverity.CRITICAL,
  FACILITY_SCOPE_VIOLATION: AuditSeverity.HIGH,
  INSUFFICIENT_GOVERNANCE_LEVEL: AuditSeverity.MEDIUM,
  PROTECTED_ROLE_VIOLATION: AuditSeverity.HIGH,
